...
export default function TenantMaintenanceRequestList() {
  ...
  const columns: TableColumn<any>[] = [
    ...
    },
    {
      ...
      cell: (row) => (
        <button
          onClick={() =>
            router.push("/admin/tenant-maintenance-request-details")
          }
  ...
  return (
    <div className="table-container max-w-full overflow-x-auto">
      <CustomDataTable
        tableName="Tenant Maintenance Request (Static)"
