...
const router = useRouter();
  ...
  {/* Create Account */}
             {/* Sign In */}
         <div className="pe-0  lg:pe-[90px] flex items-center">
  <div className="max-w-sm">
    
    {/* Icon */}
    <div className="mb-4">
      <Image
        src="/home.gif" // replace with your icon OR keep png/svg
        alt="Welcome Icon"
        width={100}
        height={60}
      />
    ...
    <h3 className="text-[16px] font-semibold text-gray-800 mb-2">
      Welcome to LHDC Housing Services
    </h3>

    {/* Description */}
    <p className="text-[13px] text-gray-500 leading-relaxed">
      We’re preparing your dashboard & setting up your onboarding experience.
      Everything will be ready in just a moment…
    </p>
            ...
            <div className="max-w-md w-full ps-0  lg:ps-[90px]">
              ...
              <div className="flex justify-between mb-6">
                {[...Array(6)].map((_, i) => (
                  <input
                    ...
                    maxLength={1}
                    inputMode="numeric"
                    className="w-[12%] h-[45px] lg:h-[50px] rounded-[6px] border border-teal-400 text-center text-[16px] font-medium focus:outline-none focus:ring-2 focus:ring-teal-500"
                    onChange={(e) => {
              ...
              {/* Verify Button */}
               ...
               <button
                onClick={() => router.push('/web-auth/login')}
