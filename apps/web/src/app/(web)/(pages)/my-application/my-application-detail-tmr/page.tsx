...
export default function MyApplicationDetailTMR({
  onBack,
}: {
  onBack: () => void;
}) 
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <h1 className="text-white text-[20px] lg:text-[35px] font-semibold">
            Tenant Maintenance Requests Application Detail
          </h1>
        </div>
      </section>
    ...
    <div className="bg-white rounded-xl p-6 shadow-sm">
      <div className="min-h-[260px]">
          ...
          <table className="w-full text-sm">
            <tbody>
              <tr className="border-b last:border-b-0">
                ...
                <td className="px-4 py-3 text-gray-900">Manoj Rawat</td>
              </tr>
              <tr className="border-b last:border-b-0">
                <td className="bg-gray-50 px-4 py-3 font-medium text-gray-700 w-1/3">
                  Application No
                </td>
                <td className="px-4 py-3 text-gray-900">TMR-2024-90832</td>
              </tr>
              <tr className="border-b last:border-b-0">
              ...
              <tr className="border-b last:border-b-0">
                ...
                <td className="px-4 py-3 text-gray-900">manoj@gmail.com</td>
              </tr>
              <tr className="border-b last:border-b-0">
                <td className="bg-gray-50 px-4 py-3 font-medium text-gray-700">
                  Phone
        ...
        <div className="flex items-end justify-end gap-4 mt-4">
          <button
  onClick={() => router.push("/rm-application-form?mode=view")}
