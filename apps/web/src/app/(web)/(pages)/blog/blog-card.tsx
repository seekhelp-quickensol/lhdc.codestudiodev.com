  ...
  return (
    <>
      <Link
        ...
        className="block"
      >
        <div className="bg-white flex-col md:flex-row rounded-2xl p-5 flex gap-5 h-full shadow-sm hover:shadow-md transition-all cursor-pointer">
          <div
  className="relative w-full md:w-[220px] h-[200px] rounded-xl overflow-hidden flex-shrink-0 bg-gray-200"
  style={{
    backgroundImage: `url(${
      blog?.blog_image
        ? blog.blog_image
